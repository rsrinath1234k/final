       ...
       let url = `https://www.balldontlie.io/api/v1/players/237`
        ...
        let currentHeading = document.querySelector(`.today`)
          ...
          <div class="text-center space-y-2">
            <div class="font-bold text-m"> ${json.first_name} ${json.last_name} is a ${json.height_feet} foot ${json.height_inches} inch ${json.weight_pounds} lb P${json.position } who currently players for the ${json.team.full_name}. Find out more on current MVP candidates by logging in below! </div>
          </div>`
        })
